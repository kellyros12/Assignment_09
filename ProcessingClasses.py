...
# KRos, 2020-Mar-22, Completed ToDos
#------------------------------------------#
...
class DataProcessor:
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        Except:
            prints Exception, and will not add track if exception is raised
        ...
        newPos, newTtl, newLnth = track_info
        try:
            newPos = int(newPos)
            track = DC.Track(newPos, newTtl, newLnth)
            cd.add_track(track)
